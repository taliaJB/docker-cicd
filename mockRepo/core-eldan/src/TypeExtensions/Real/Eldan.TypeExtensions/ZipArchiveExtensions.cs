...
namespace Eldan.TypeExtensions
{
    public static class ZipArchiveExtensions
    {
        ...
        {
            using (FileStream zipToOpen = new FileStream(sourceArchiveFileName, FileMode.Open))
            {
                new ZipArchive(zipToOpen).ExtractToDirectory(destinationDirectoryName, overwrite);
            }
        }
